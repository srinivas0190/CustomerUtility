 ...
 * 2016-08-17T04:37:42.745-05:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "ServicePlanWSService", 
                  wsdlLocation = "file:/C:/BCJMay16/Development/CustomerUtilityRepo/CustomerServiceManager/src/main/resources/netsuite.wsdl",
...
public class ServicePlanWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJMay16/Development/CustomerUtilityRepo/CustomerServiceManager/src/main/resources/netsuite.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServicePlanWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJMay16/Development/CustomerUtilityRepo/CustomerServiceManager/src/main/resources/netsuite.wsdl");
        }
        WSDL_LOCATION = url;
    }
